...
client.on('message', function (message) {
    ...
    if (message.content.startsWith(prefix + "say")) {
        message.delete()
        if(!message.guild.member(message.author).hasPermission("MANAGE_MESSAGES")) return message.channel.send("**:x: Vous n'avez pas la permission `Gérér les messages` dans ce serveur**");
